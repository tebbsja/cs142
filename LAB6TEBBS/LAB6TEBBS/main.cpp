...
void printHotPlate(double current_temperature[][COLUMNS])
{
...
void initializeHotPlate(double temperature[][COLUMNS])
{
...
void averageHotPlate(double current_temperature[][COLUMNS], double previous_temperature[][COLUMNS])
{
...
double checkDifferenceDegrees(double current_temperature[][COLUMNS], double previous_temperature[][COLUMNS])
{
...
void exportHotPlate(double current_temperature[][COLUMNS])
{
    
    ofstream output;
    
    output.open("lab6output.csv");
